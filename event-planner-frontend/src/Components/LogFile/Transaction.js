...
function Transaction({ from, task, amount, date, to, fromAccount, toAccount }) {
    ...
    <div className="transaction">
      <div className="transaction__details">
        ...
        <div className="transaction__task">
          <h3>{task.task ? task.task : task.to_user }</h3>
          <p>{date}</p>
        </div>
      </div>
                ...
                <div className="transDetails__body">
                  <div className="transDetails__to">
                    <div className="transDetails__to__details">
                      <p>TO</p>
                      <h3>{toAccount.bank_name}</h3>
                      <h4>A/c No. {toAccount.account_number}</h4>
                    </div>
                  ...
                  <div className="transDetails__from">
                    <div className="transDetails__from__details">
                      <p>FROM</p>
                      <h3>{fromAccount.bank_name}</h3>
                      <h4>A/c No. {fromAccount.account_number}</h4>
                    </div>

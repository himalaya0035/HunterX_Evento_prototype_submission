...
function Profile() {
  ...
  return (
    <div className="profile__main">
      <div className="profile" style={{marginBottom:"20px"}}>
      ...
      <div className="kycContainer" style={{marginTop:"0px",marginBottom:"20px"}}>
         <h4 style={{flex:2, marginRight:"30px", textAlign:"center",marginBottom:"20px"}}>
           Complete your minimal KYC to unlock all the features of Evento.
         </h4>
         <button style={{flex:1, width:"100%"}} onClick = {handleOpenKyc} className="completeKycButton">Complete</button>
         {openKyc && <KycModal open={openKyc} handleClose={handleCloseKyc} />}
       </div>
        <div className="bank__add">
          <h1>Your Bank Accounts</h1>
          <button onClick={handleOpen} style={{width:"200px"}}>Add Bank Acc</button>
        </div>
        ...
        <div className="bankAcc__container" style={{marginBottom:"80px"}}>
          {banks.map((bank) => (
